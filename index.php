...
print '<a href="hgc_design_grant_chart/" class="btn btn-sm btn-primary pull-right">Design Grant Chart for project</a>';
...
function manual_create_table($query,$fieldname,$id='mytable'){
   ...
   print'<tr>';
	...
	print '  <td><a href="project_effort.php?pid='.$row[0].'" class="btn btn-sm btn-primary">Effort Calculation</a></td>';
	print' </tr>';
